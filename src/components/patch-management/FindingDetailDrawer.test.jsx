...
//   · en la selección NO hay «Apply»: sólo simular;
//   · «Apply» aparece cuando TODOS han contestado la simulación, y va sólo a
//     los que dijeron «would apply» — nunca a la selección entera;
...
import { getDevicesAffectedByCheck, remediate, getRemediationResults } from "../../api/patchManagement";
...
describe("simular, luego aplicar", () => {
  it("⭐ en la selección no hay Apply: sólo simular", async () => {
    open();
